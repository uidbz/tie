...
func (t *Tree) internalLookupComparator(cmp Comparator, parent *Node, this *Node, key interface{}, dir Direction) (bool, *Node, Direction) {
	switch {
	case this == nil:
		return false, parent, dir
	case cmp(key, this.key) == 0:
		return true, parent, dir
	case cmp(key, this.key) < 0:
		return t.internalLookupComparator(cmp, this, this.left, key, LEFT)
	case cmp(key, this.key) > 0:
		return t.internalLookupComparator(cmp, this, this.right, key, RIGHT)
	default:
		return false, parent, NODIR
	}
}
...
func (t *Tree) HasKeyComparator(cmp Comparator, key interface{}) bool {
	...
	// 	return false
	// }
	found, _, _ := t.internalLookupComparator(cmp, nil, t.root, key, NODIR)
	return found
}
